compute_nowcast <- function(pathogen, forecast_date){
  ...
  reporting_data_raw <- load_survstat(pathogen, forecast_date)
  ...
  filename <- str_glue("RESPINOW/nowcasts_retrospective/{pathogen}/{forecast_date}-KIT-KEW.csv")
